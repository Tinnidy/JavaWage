...
public class BankInfo extends JInternalFrame {
	...
	JPanel panel2;
	JPanel panel3;
	String tableName = "bank_info_view";
	String usr_position;
	public BankInfo(String usr_id) throws SQLException {
		init_layout();
	...
	public void init_layout() throws SQLException {
		...
		table.setModel(new DefaultTableModel(null, columnName) {
			...
			public boolean isCellEditable(int row, int column) {
				...
				if(column == columnName.length - 2 || column == columnName.length - 1)
					return true;
				else
					return false;
			}
